import type { AgentTurnRequest, ToolCallEnvelope } from '../types/contracts.js';
...
const completedToolCalls: ToolCallEnvelope[] = (response.events ?? [])
...
const nodeById = new Map<string, { id: string; key: string; text: string; x: number; y: number }>();
