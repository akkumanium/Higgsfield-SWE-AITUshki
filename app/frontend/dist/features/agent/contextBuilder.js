function overlapsViewport(viewport, shape, margin = 160) {
...
function viewportOverlapScore(viewport, shape) {
...
function compressClusterShapes(shapes) {
...
export function buildAgentContext(request, shapes = []) {
