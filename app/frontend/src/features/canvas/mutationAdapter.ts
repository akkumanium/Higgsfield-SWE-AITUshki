    ...
    return [
      {
        ...
        payload: {
          shapeInput: {
            ...
            props: {
              text: toStringValue(arguments_.text, 'New note'),
            },
          },
        },
      },
    ...
    return [
      {
        ...
        payload: {
          shapeInput: {
            ...
            props: {
              text: `Summary generated by agent for region ${Math.round(regionX)},${Math.round(regionY)} ${Math.round(regionWidth)}x${Math.round(regionHeight)}`,
            },
          },
        },
      },
    ...
    const operations: CanvasMutationOperation[] = [
      {
        ...
        payload: {
          shapeInput: {
            ...
            y: 200,
            props: {
              text: `${clusterLabel} (${shapeIds.length} shapes)`,
            },
            meta: {
              clusterId: id,
    ...
    return [
      {
        ...
        payload: {
          shapeInput: {
            ...
            props: {
              text: `Image placeholder: ${toStringValue(arguments_.prompt, 'Untitled image')}`,
            },
          },
        },
      },
